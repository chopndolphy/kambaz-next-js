                ...
                <div className="wd-selector-1">
                    ...
                    <div className="wd-selector-2">
                        ...
                        <p className="wd-selector-3">
                            ...
                            depending on the document structure .wd-selector-4 is a direct
                            child of .wd-selector-3 and is a descendant of .wd-selector-2 and
                            is a descendant of .wd-selector-1
                        </p>
                    </div>
                </div>
            </div>
