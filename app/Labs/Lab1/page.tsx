        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Brown ground beef in pan</li>
                    <li>Drain fat from pan</li>
                    <li>
                        Add taco seasoning and water to pan and let simmer until reduced
                    </li>
                    <li>Bake taco shells in oven</li>
                    <li>Shred lettuce and dice tomato</li>
                    <li>Remove taco shells from the oven</li>
                    <li>
                        Add (in order) beef, cheese, lettuce, tomato, and hot sauce into the
                        taco shells
                    </li>
                    <li>Serve and enjoy!</li>
                </ol>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <button type="button" onClick={handleClick} id="wd-all-good">
                        Hello World!
                    </button>
                ...
                <br />
                Please&nbsp;
                <a href="https://github.com/chopndolphy/kambaz-next-js" id="wd-github">
                    click here
                </a>
